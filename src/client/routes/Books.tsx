    ...
    <div className="py-16">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="space-y-8">
          {/* Book 1 */}
          <div className="rounded-lg border border-gray-200 p-6 flex flex-col sm:flex-row gap-6">
            <img
              src="/demo/images/book-hydraulic-fracturing.jpg"
              alt="Environmental Considerations Associated with Hydraulic Fracturing Operations book cover"
          ...
          <div className="rounded-lg border border-gray-200 p-6 flex flex-col sm:flex-row gap-6">
            <img
              src="/demo/images/book-oil-spills.jpg"
              alt="Oil Spills and Gas Leaks book cover"
              className="w-28 h-36 object-cover rounded shadow flex-shrink-0"
            />
            <div>
              <h2 className="text-lg font-semibold text-gray-900">
          ...
          <div className="rounded-lg border border-gray-200 p-6 flex flex-col sm:flex-row gap-6">
            <img
              src="/demo/images/book-acid-mine-drainage.jpg"
              alt="Acid Mine Drainage, Rock Drainage, and Acid Sulfate Soils book cover"
              className="w-28 h-36 object-cover rounded shadow flex-shrink-0"
            />
            <div>
              <h2 className="text-lg font-semibold text-gray-900">
          ...
          <div className="rounded-lg border border-gray-200 p-6 flex flex-col sm:flex-row gap-6">
            <img
              src="/demo/images/book-chromium.jpg"
              alt="Chromium(VI) Handbook book cover"
              className="w-28 h-36 object-cover rounded shadow flex-shrink-0"
            />
            <div>
              <h2 className="text-lg font-semibold text-gray-900">
          ...
          <div className="rounded-lg border border-gray-200 p-6 flex flex-col sm:flex-row gap-6">
            <img
              src="/demo/images/book-mtbe.jpg"
              alt="MTBE: Effects on Soil and Groundwater Resources book cover"
              className="w-28 h-36 object-cover rounded shadow flex-shrink-0"
            />
            <div>
              <h2 className="text-lg font-semibold text-gray-900">
